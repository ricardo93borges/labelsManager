...
$router = new Router();
$router->add('/^\/?projects\/?$/', 'ProjectController.php', 'getProjetos', 'GET');
$router->add('/^\/?project\/\d?.\/labels\/?$/', 'ProjectController.php', 'getLabels', 'GET');
$router->add('/^\/?project\/\d?.\/labels\/?$/', 'ProjectController.php', 'addLabels', 'POST');
